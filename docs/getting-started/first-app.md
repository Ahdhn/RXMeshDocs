...
This example touches on several core RXMesh concepts, e.g., mesh [attributes](../rxmesh/static/working_with_attributes.md), element-wise traversal with [`for_each`](../rxmesh/static/for_each.md), [connectivity-based`for_each<Op, blockThreads>`](../rxmesh/static/for_each.md#connectivity-for_each-query-op) computation, and moving data between the host and device. In the following sections, we will explore these ideas in more depth and cover [additional operations on static meshes](../rxmesh/static/static.md), [attribute manipulation](../rxmesh/static/working_with_attributes.md), working with [sparse](../rxmesh/matrix/sparse_matrices.md) and [dense](../rxmesh/matrix/dense_matrices.md) matrices, [linear system solvers](../rxmesh/matrix/solvers.md), [handling dynamic connectivity](../rxmesh/dyn/dynamic.md), and performing [automatic differentiation](../rxmesh/diff/ad.md) on the GPU.
