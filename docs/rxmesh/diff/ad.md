...
Most of the machinery already documented in the rest of the library, i.e., [`DenseMatrix`](../dense_matrices.md), [`SparseMatrix`](../sparse_matrices.md), [linear solvers](../solvers.md), and [`for_each`](../for_each.md), is reused under the hood. The AD layer adds one new arithmetic primitive (the [`Scalar`](scalar.md) dual number) and two problem types that orchestrate assembly and evaluation.
